...
Spark.C adapts the QSA valid-count and selected-K/V compaction kernels from
...
`models/qwen3.8-flash-next/native/kernels/cuda/qsa_kv_pack_sglang.cu` preserves `_fa2_valid_counts` and
