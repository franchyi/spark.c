...
Spark.C borrows the Qwen3.8 Flash-Next GDN arithmetic from two immutable,
...
is specialized in `models/qwen3.8-flash-next/native/kernels/cuda/gdn_block_sglang.cu`; framework allocation,
...
`vendor/tools/export-gdn-aot.py` for T=1, QH=16, VH=48, K=V=128, BF16 state, and
