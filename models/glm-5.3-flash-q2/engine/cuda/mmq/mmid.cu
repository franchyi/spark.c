...
// With the switch off the mmq_runtime.cu callers refuse past-cap shapes exactly
...
void ggml_cuda_launch_mm_ids_helper(
    ...
    switch (n_expert_used) {
        case  1:
            ...
            // assignment rows as single-expert "tokens" (mmq_runtime.cu
            // mmq_runtime_moe_impl, n_expert_used=1).  Without this case it fell to
