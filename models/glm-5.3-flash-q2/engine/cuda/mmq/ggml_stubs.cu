...
// Implementations of the ggml-API stubs declared in ggml_stubs.h plus
...
#include "common.cuh"   // pulls in ggml_stubs.h via redirect headers
 ...
 * mmq_runtime.cu wrappers; an explicit stream=0 means the legacy default
