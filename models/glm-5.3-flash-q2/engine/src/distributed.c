/* =========================================================================
 * distributed.c - Distributed inference runtime.
 * =========================================================================
 *
 ...
 * active, engine.c delegates sync/eval/save/load to the coordinator session API in
 * this file.
 *
...
static const char *dist_role_name(distributed_role role) {
    switch (role) {
 ...
 * Program frontends should keep using ds4_session_sync/eval/save/load; engine.c
...
static bool dist_parse_role(const char *s, distributed_role *out) {
...
static bool dist_parse_layers(const char *s, distributed_layers *out, char *err, size_t errlen) {
    if (!s || !out) {
