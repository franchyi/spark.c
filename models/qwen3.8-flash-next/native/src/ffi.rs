...
unsafe extern "C" {
    pub fn flash_coherent_region_validate(config: *const CoherentRegionConfig) -> Status;
    pub fn flash_coherent_region_create(
        config: *const CoherentRegionConfig,
        region: *mut *mut CoherentRegion,
    ) -> Status;
    pub fn flash_coherent_region_view(
    ...
    pub fn flash_cuda_stream_memcpy_async(
        stream: *mut CudaStream,
    ...
    pub fn flash_cuda_event_record(event: *mut CudaEvent, stream: *mut CudaStream) -> Status;
    pub fn flash_cuda_event_query(event: *const CudaEvent, complete: *mut u32) -> Status;
    pub fn flash_cuda_event_synchronize(event: *mut CudaEvent) -> Status;
    pub fn flash_cuda_event_destroy(event: *mut CudaEvent) -> Status;
    pub fn flash_cuda_blas_create(blas: *mut *mut CudaBlas) -> Status;
    pub fn flash_cuda_blas_raw(blas: *const CudaBlas, raw_blas: *mut *mut c_void) -> Status;
    ...
    pub fn flash_qwen_ple_block_launch(args: *const QwenPleBlockArgs) -> Status;
    pub fn flash_qwen_repeat_embedding_launch(args: *const QwenDecodeGlueArgs) -> Status;
    ...
    pub fn flash_qwen_runtime_gdn_decode(
        caps: *const DeviceCaps,
        args: *const GdnDecodeArgs,
    ) -> Status;
    pub fn flash_qwen_runtime_gdn_finish(
        caps: *const DeviceCaps,
        args: *const GdnBlockArgs,
    ) -> Status;
    pub fn flash_qwen_runtime_bf16_to_f32(args: *const QwenBf16ToF32Args) -> Status;
    pub fn flash_qwen_runtime_grouped_nvfp4(
        caps: *const DeviceCaps,
    ...
    pub fn flash_qwen_runtime_segmented_silu(
        caps: *const DeviceCaps,
    ...
    pub fn flash_qwen_runtime_moe_finalize(
        caps: *const DeviceCaps,
        args: *const MoeRouteArgs,
    ) -> Status;
    pub fn flash_qwen_runtime_shared_expert(
        caps: *const DeviceCaps,
    ...
    pub fn flash_grouped_nvfp4_launch(
        caps: *const DeviceCaps,
        args: *const GroupedNvfp4Args,
    ) -> Status;
    ...
    pub fn flash_segmented_silu_nvfp4_launch(
        caps: *const DeviceCaps,
        args: *const SegmentedSiluNvfp4Args,
    ) -> Status;
    pub fn flash_segmented_nvfp4_quantize_validate(
        plan: *const SegmentedNvfp4QuantizePlan,
    ) -> Status;
    pub fn flash_segmented_nvfp4_quantize_query(
        caps: *const DeviceCaps,
        plan: *const SegmentedNvfp4QuantizePlan,
        info: *mut KernelInfo,
    ) -> Status;
    pub fn flash_segmented_nvfp4_quantize_launch(
        caps: *const DeviceCaps,
        args: *const SegmentedNvfp4QuantizeArgs,
    ) -> Status;
    pub fn flash_moe_route_validate(plan: *const MoeRoutePlan) -> Status;
    pub fn flash_moe_route_query(
        caps: *const DeviceCaps,
    ...
    pub fn flash_moe_gate_launch(caps: *const DeviceCaps, args: *const MoeGateArgs) -> Status;
    pub fn flash_shared_expert_validate(plan: *const SharedExpertPlan) -> Status;
    pub fn flash_shared_expert_query(
        caps: *const DeviceCaps,
        plan: *const SharedExpertPlan,
        info: *mut KernelInfo,
    ) -> Status;
    pub fn flash_shared_expert_launch(
        caps: *const DeviceCaps,
        args: *const SharedExpertArgs,
    ) -> Status;
    pub fn flash_moe_join_validate(plan: *const MoeJoinPlan) -> Status;
    pub fn flash_moe_join_query(
        caps: *const DeviceCaps,
        plan: *const MoeJoinPlan,
        info: *mut KernelInfo,
    ) -> Status;
    pub fn flash_moe_join_launch(caps: *const DeviceCaps, args: *const MoeJoinArgs) -> Status;
    pub fn flash_mhc_validate(plan: *const MhcPlan) -> Status;
    pub fn flash_mhc_query(
        caps: *const DeviceCaps,
        plan: *const MhcPlan,
        info: *mut KernelInfo,
    ) -> Status;
    pub fn flash_mhc_mix_launch(caps: *const DeviceCaps, args: *const MhcArgs) -> Status;
    pub fn flash_mhc_combine_launch(caps: *const DeviceCaps, args: *const MhcArgs) -> Status;
    pub fn flash_ple_gather_validate(plan: *const PleGatherPlan) -> Status;
    pub fn flash_ple_gather_query(
        caps: *const DeviceCaps,
    ...
    pub fn flash_qsa_topk_launch(caps: *const DeviceCaps, args: *const QsaTopkArgs) -> Status;
    pub fn flash_qsa_expand_validate(plan: *const QsaExpandPlan) -> Status;
    pub fn flash_qsa_expand_query(
        caps: *const DeviceCaps,
    ...
    pub fn flash_qsa_index_prep_launch(
        caps: *const DeviceCaps,
        args: *const QsaIndexPrepArgs,
    ) -> Status;
    pub fn flash_qsa_kv_pack_validate(plan: *const QsaKvPackPlan) -> Status;
    pub fn flash_qsa_kv_pack_query(
        caps: *const DeviceCaps,
    ...
    pub fn flash_gdn_block_prepare_launch(
        caps: *const DeviceCaps,
        args: *const GdnBlockArgs,
    ) -> Status;
