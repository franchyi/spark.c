...
extern "C" int
__tvm_ffi_flash_gdn_bf16_t1_h16_hv48_k128_v128_sm121(
    void* handle, const TVMFFIAny* args, int32_t num_args,
    TVMFFIAny* result);

#ifdef FLASH_WITH_FLASHINFER_GDN_PREFILL_AOT
#define FLASH_DECLARE_GDN_PREFILL(TOKENS)                              \
  extern "C" int                                                         \
      __tvm_ffi_flash_gdn_bf16_t##TOKENS##_h16_hv48_k128_v128_sm121( \
          void* handle, const TVMFFIAny* args, int32_t num_args,           \
          TVMFFIAny* result)
FLASH_DECLARE_GDN_PREFILL(2);
FLASH_DECLARE_GDN_PREFILL(4);
FLASH_DECLARE_GDN_PREFILL(8);
FLASH_DECLARE_GDN_PREFILL(16);
#undef FLASH_DECLARE_GDN_PREFILL
#endif
...
FlashStatus RaisedError(const char* prefix) {
...
int CallArtifact(uint32_t tokens, const TVMFFIAny* args, int32_t num_args,
  ...
  switch (tokens) {
    case 1:
      return __tvm_ffi_flash_gdn_bf16_t1_h16_hv48_k128_v128_sm121(
          nullptr, args, num_args, result);
#ifdef FLASH_WITH_FLASHINFER_GDN_PREFILL_AOT
    case 2:
      return __tvm_ffi_flash_gdn_bf16_t2_h16_hv48_k128_v128_sm121(
          nullptr, args, num_args, result);
    case 4:
      return __tvm_ffi_flash_gdn_bf16_t4_h16_hv48_k128_v128_sm121(
          nullptr, args, num_args, result);
    case 8:
      return __tvm_ffi_flash_gdn_bf16_t8_h16_hv48_k128_v128_sm121(
          nullptr, args, num_args, result);
    case 16:
      return __tvm_ffi_flash_gdn_bf16_t16_h16_hv48_k128_v128_sm121(
          nullptr, args, num_args, result);
#endif
    default:
      return -1;
