/*
 * Flash raw-pointer adapter for FlashInfer's Apache-2.0 CUTLASS FP4 GEMM.
...
// links the generated tactic objects into its extension. Flash instantiates
...
FlashStatus flash_flashinfer_nvfp4_launch(
  ...
  const size_t required =
      flash_flashinfer_nvfp4_workspace_bytes(&args->plan);
