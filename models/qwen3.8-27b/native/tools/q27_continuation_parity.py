...
Torch, CUDA, or any Q27 runtime module.
...
SUITE_SCHEMA = "q27.q27.continuation-suite.v1"
ORACLE_SCHEMA = "q27.q27.sglang-greedy-trace.v1"
VOCABULARY = 248_320
HIDDEN_SIZE = 5_120
TOP_K = 5
...
def main() -> int:
    ...
    try:
        ...
        report = {
            "schema": "q27.q27.continuation-acceptance-report.v1",
