...
if [[ ! -d "$destination/.git" ]]; then
  ...
  git -C "$destination" remote add origin https://github.com/sgl-project/sglang.git
fi
git -C "$destination" remote set-url origin https://github.com/sgl-project/sglang.git
