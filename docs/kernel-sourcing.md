...
| QSA decode | SGLang Qwen4 backend plus FlashInfer XQA | Pinned index prep, radix top-k, block expansion, selected-K/V pack, and BF16 H=256 page-64 XQA are linked behind the raw ABI; Rust owns coherent buffers, scratch, leases, and page tables | score MQA, joined graph, prefill split, and FP8-KV edge cases |
