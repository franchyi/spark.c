...
| QSA decode | SGLang Qwen4 backend plus FlashInfer XQA | Pinned BF16 H=256, page-64 SM121 source is linked behind the raw ABI; Rust owns scratch and page tables | graph integration, prefill split, and FP8-KV edge cases |
