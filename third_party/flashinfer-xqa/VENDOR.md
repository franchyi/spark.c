...
SparkServe directly compiles FlashInfer's XQA paged-attention source at commit
...
`csrc/cuda/qsa_decode_xqa_flashinfer.cu` is only a raw-pointer wrapper around
