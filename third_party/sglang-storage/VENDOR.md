...
SparkServe's persistent `io_uring` submission/completion structure is adapted
...
waits for every completion, then copies each page into Python bytes. SparkServe
